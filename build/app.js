...
enyo.path.addPaths({layout: "/Users/zlargon/GitHub/CriminalCaseAutoPetFeed/enyo/../lib/layout/", onyx: "/Users/zlargon/GitHub/CriminalCaseAutoPetFeed/enyo/../lib/onyx/source/", widget: "source/widget/"});
...
th: b,
"*": u.createElement("div")
}, E = /complete|loaded|interactive/, S = /^\.([\w-]+)$/, x = /^#([\w-]*)$/, T = /^[\w-]*$/, N = {}, C = N.toString, k = {}, L, A, O = u.createElement("div"), M = {
tabindex: "tabIndex",
readonly: "readOnly",
"for": "htmlFor",
"class": "className",
...
if (typeof t == "string") {
t = t.trim();
if (t[0] == "<" && c.test(t)) i = k.fragment(t, RegExp.$1, r), t = null; else {
...
if (k.isZ(t)) return t;
if (F(t)) i = q(t); else if (B(t)) i = [ t ], t = null; else if (c.test(t)) i = k.fragment(t.trim(), RegExp.$1, r), t = null; else {
if (r !== e) return n(r).find(t);
i = k.qsa(u, t);
}
}
...
var n, r = [], i, s;
if (I(e)) for (i = 0; i < e.length; i++) n = t(e[i], i), n != null && r.push(n); else for (s in e) n = t(e[s], s), n != null && r.push(n);
return R(r);
}, n.each = function(e, t) {
var n, r;
if (I(e)) {
...
if (B(n)) for (t in n) Q(this, t, n[t]); else Q(this, n, K(this, r, e, this.getAttribute(n)));
});
},
...
var r = n(this), i = K(this, e, t, r.offset()), s = r.offsetParent().offset(), o = {
top: i.top - s.top,
left: i.left - s.left
};
...
}) : u = U(e) + ":" + W(e, r); else for (t in e) !e[t] && e[t] !== 0 ? this.each(function() {
...
t.log("Garbage collecting!"), r.parentNode.removeChild(r), e[n] = void 0;
try {
delete e[n];
} catch (i) {}
}, i = function(e, t) {
var n = "", r, i;
for (r in e) e.hasOwnProperty(r) && (r = t ? encodeURIComponent(r) : r, i = t ? encodeURIComponent(e[r]) : e[r], n += r + "=" + i + "&");
return n.replace(/&$/, "");
}, s = function() {
for (var e = "", e = [], t = 0, t = 0; t < 32; t += 1) e[t] = "0123456789ABCDEF".substr(Math.floor(Math.random() * 16), 1);
return e[12] = "4", e[16] = "0123456789ABCDEF".substr(e[16] & 3 | 8, 1), e = "flyjsonp_" + e.join("");
}, o = function(e, n) {
t.log(n), typeof e != "undefined" && e(n);
}, u = function(e, n) {
t.log("GET success"), typeof e != "undefined" && e(n), t.log(n);
}, a = function(e, n) {
t.log("POST success"), typeof e != "undefined" && e(n), t.log(n);
}, f = function(e) {
t.log("Request complete"), typeof e != "undefined" && e();
}, t = {
options: {
debug: !1
}
...
var n;
t.log("Initializing!");
for (n in e) e.hasOwnProperty(n) && (t.options[n] = e[n]);
return t.log("Initialization options"), t.log(t.options), !0;
}, t.log = function(n) {
e.console && t.options.debug && e.console.log(n);
}, t.get = function(h) {
var h = h || {}, p = h.url, d = h.callbackParameter || "callback", v = h.parameters || {}, y = e.document.createElement("script"), b = s(), w = "?";
if (!p) throw Error("URL must be specified!");
v[d] = b, p.indexOf("?") >= 0 && (w = "&"), p += w + i(v, !0), e[b] = function(e) {
typeof e == "undefined" ? o(h.error, "Invalid JSON data returned") : h.httpMethod === "post" ? (e = e.query.results, !e || !e.postresult ? o(h.error, "Invalid JSON data returned") : (e = e.postresult.json ? e.postresult.json : e.postresult, a(h.success, e))) : u(h.success, e), r(b, y), f(h.complete);
}, t.log("Getting JSONP data"), y.setAttribute("src", p), e.document.getElementsByTagName("head")[0].appendChild(y), n(y, "error", function() {
r(b, y), f(h.complete), o(h.error, "Error while trying to access the URL");
});
}, t.post = function(e) {
var e = e || {}, n = e.url, r = e.parameters || {}, s = {};
if (!n) throw Error("URL must be specified!");
n = "https://query.yahooapis.com/v1/public/yql?q=" + encodeURIComponent('select * from jsonpost where url="' + n + '" and postdata="' + i(r, !1) + '"') + "&format=json&jsonCompat=new&env=" + encodeURIComponent("store://datatables.org/alltableswithkeys"), s.url = n, s.httpMethod = "post", typeof e.success != "undefined" && (s.success = e.success), typeof e.error != "undefined" && (s.error = e.error), typeof e.complete != "undefined" && (s.complete = e.complete), t.get(s);
}, t;
}(this);
...
create: function() {
this.inherited(arguments), this.mainTextChanged(), this.leftButtonTextChanged(), this.rightButtonTextChanged();
},
mainTextChanged: function(e) {
this.$.mainText.setContent(this.mainText);
},
leftButtonTextChanged: function(e) {
this.$.leftButton.addRemoveClass("hide", this.leftButtonText == null), this.$.leftButton.setContent(this.leftButtonText);
},
rightButtonTextChanged: function(e) {
this.$.rightButton.addRemoveClass("hide", this.rightButtonText == null), this.$.rightButton.setContent(this.rightButtonText);
},
leftCallback: function(e, t) {
return this.hide(), !0;
},
rightCallback: function(e, t) {
return this.hide(), !0;
},
setButtonCallback: function(e, t) {
var n = function(e, t) {
return this.hide(), !0;
};
this.leftCallback = typeof e == "function" ? e : n, this.rightCallback = typeof t == "function" ? t : n;
}
});
...
PET_MAX_LOYALTY: function(e, t) {
var n = [ 1, 4, 12, 24, 0 ];
return (20 + Math.ceil(e / 3) * 10) * n[t - 1];
},
components: [ {
kind: "onyx.Toolbar",
layoutKind: "FittableColumnsLayout",
...
kind: "onyx.Button",
content: "OK",
ontap: "startToGetUserIdFromFacebook"
} ]
}, {
name: "alert",
kind: "ConfirmPopup",
...
rendered: function() {
document.addEventListener("backbutton", enyo.bind(this, "backButtonHandler")), this.inherited(arguments);
var e = localStorage.getItem("App.userName");
e !== null && (this.$.inputUserName.setValue(e), this.startToGetUserIdFromFacebook()), this.$.leavePopup.setButtonCallback(enyo.bind(this, function() {
return this.$.leavePopup.hide(), navigator.app.exitApp(), !0;
}));
},
...
blockUI: function(e) {
this.$.blockUI.hide(), enyo.isString(e) && (this.$.blockUIMessage.setContent(e), this.$.blockUI.show());
},
alert: function(e) {
this.$.alert.hide(), enyo.isString(e) && (this.$.alert.setMainText(e), this.$.alert.show());
},
showUserPopup: function() {
return this.$.userPopup.show(), this.$.inputUserName.focus(), !0;
},
keyupEventHandler: function(e, t) {
if (t.keyCode !== 13) return !0;
switch (e.name) {
case "userPopup":
...
this.timerStop();
var e = this.$.inputUserName.getValue();
if (e === "") {
this.alert("please set the user name or id");
return;
}
return this.blockUI("loading..."), this.getUserInfoByUserNameOrId(e, enyo.bind(this, function(t) {
localStorage.setItem("App.userName", e), this.$.toolbarHeader.setContent(t.name + "'s Pets"), this.userId = t.id, this.$.userPopup.hide(), this.blockUI("fetch pet list..."), this.getPetListAndRefreshUI();
}), enyo.bind(this, function(e) {
this.blockUI(null), this.alert(e);
})), !0;
},
setupItem: function(e, t) {
var n = this.petList[t.index];
this.$.petIcon.setClasses("icon pet-icon-" + (n.id - 1)), this.$.petLevel.setContent("Level: " + n.level), this.$.petLoyalty.setContent("Loyalty: " + n.loyalty + "/" + this.PET_MAX_LOYALTY(n.id, n.level)), this.$.petCooldown.setContent("Cooldown: " + this.timerFormat(n.cooldown));
},
refreshList: function() {
this.$.list.setCount(this.petList.length), this.$.list.render();
},
...
var r = typeof t == "function" ? t : function() {}, i = typeof n == "function" ? n : function() {};
if (typeof e != "string") {
i("parameters type error");
return;
}
(new enyo.Ajax({
...
if (typeof t != "object" || typeof t.id != "string" || typeof t.name != "string") {
i("server return unexpected response");
return;
}
r(t);
}).error(function(e, t) {
...
case 404:
try {
i(JSON.parse(e.xhrResponse.body).error.message);
} catch (n) {
i("server return unexpected response " + t);
}
break;
default:
i("unknown error");
...
feedPet: function(e, t, n, r, i) {
if (typeof e != "string" || typeof t != "number" || typeof n != "number") {
o("parameters type error");
return;
}
var s = enyo.isFunction(r) ? r : function() {}, o = enyo.isFunction(i) ? i : function() {};
FlyJSONP.post({
...
if (typeof e.error != "object" || typeof e.error.type != "string") {
o("server return unexpected response " + JSON.stringify(e));
return;
}
switch (e.error.type) {
case "pet":
if (typeof e.error.pets == "object" && typeof e.error.pets.adopted == "object") {
var t = [];
$.each(e.error.pets.adopted, function(e, n) {
n.id = parseInt(e), t.push(n);
}), o("err_" + e.error.code.toLowerCase(), t);
return;
}
default:
o("err_" + e.error.type);
...
getPetList: function(e, t, n) {
var r = enyo.isFunction(t) ? t : function() {}, i = enyo.isFunction(n) ? n : function() {}, s = enyo.bind(this, function(t) {
this.feedPet(e, t, this.PET_FOOD.cookie, function() {
s(t);
}, function(e, t) {
if (Array.isArray(t)) {
r(t);
...
feedPetByList: function(e, t, n) {
var r = function() {
var e = 0;
return function() {
e++, e === t.length && enyo.isFunction(n) && n();
};
}();
$.each(t, enyo.bind(this, function(t, n) {
if (n.level === 5) {
console.log("feed pet " + this.PET_NAME[n.id - 1] + "(" + n.id + ") failure: max level"), r();
return;
}
this.feedPet(e, n.id, n.level === 4 && this.PET_MAX_LOYALTY(n.id, n.level) - n.loyalty <= 10 ? this.PET_FOOD.chicken : this.PET_FOOD.cookie, enyo.bind(this, function() {
console.log("feed pet " + this.PET_NAME[n.id - 1] + "(" + n.id + ") success"), r();
}), enyo.bind(this, function(e) {
console.log("feed pet " + this.PET_NAME[n.id - 1] + "(" + n.id + ") failure: " + e), r();
}));
}));
},
timerId: -1,
...
var t = e % 60, n = Math.floor(e / 60 % 60), r = Math.floor(e / 60 / 60);
return enyo.format("%s:%s:%s", r, n, t).replace(/\b(\d)\b/g, "0$1");
},
timerStop: function() {
clearInterval(this.timerId);
},
timerStart: function() {
this.timerStop(), this.timerId = setInterval(enyo.bind(this, function() {
for (var e = 0; e < this.petList.length; e++) {
if (this.petList[e].level === 5) continue;
this.petList[e].cooldown--;
if (this.petList[e].cooldown > 0) {
this.$.list.renderRow(e);
continue;
}
this.timerStop(), this.blockUI("feeding pets..."), this.feedPetByList(this.userId, this.petList, enyo.bind(this, function() {
this.blockUI("update pet list..."), this.getPetListAndRefreshUI();
}));
break;
}
}), 1e3);
